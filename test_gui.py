...
def test_gui_creation():
    ...
    with patch('dj_mixer.pygame') as mock_pygame:
        ...
        assert abs(app.crossfader_var.get() - 0.3) < 0.01, "Crossfader position not updated"
...
def test_gui_layout():
    ...
    with patch('dj_mixer.pygame') as mock_pygame:
        ...
        assert app.root.title() == "DJ Mixer - Multi-Device Audio Mixing System", "Window title incorrect"
