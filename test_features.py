...
class TestPlaylistManagement:
    ...
    def test_filter_by_bpm(self):
        ...
        playlist = Playlist()
        playlist.add_track(
            PlaylistTrack(path="/track1.mp3", title="Track 1", bpm=120.0)
        )
        playlist.add_track(
            PlaylistTrack(path="/track2.mp3", title="Track 2", bpm=140.0)
        )
        playlist.add_track(
            PlaylistTrack(path="/track3.mp3", title="Track 3", bpm=128.0)
        )
    ...
    def test_sort_by_bpm(self):
        ...
        playlist = Playlist()
        playlist.add_track(
            PlaylistTrack(path="/track1.mp3", title="Track 1", bpm=140.0)
        )
        playlist.add_track(
            PlaylistTrack(path="/track2.mp3", title="Track 2", bpm=120.0)
        )
        playlist.add_track(
            PlaylistTrack(path="/track3.mp3", title="Track 3", bpm=128.0)
        )
